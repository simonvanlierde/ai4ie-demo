...
The copy-paste page: prompts that have worked for the group, and complete Claude
skill files. Everything here is meant to leave this site with you.
...
[reproducibility checklist](/ai4ie-demo/best-practices/checklists/#machine-learning-reproducibility)
run against it.*
