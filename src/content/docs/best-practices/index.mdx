...
[verification checklists](/ai4ie-demo/best-practices/checklists/) and the
[copy-pasteable prompts and skill files](/ai4ie-demo/best-practices/prompts-and-skills/).
...
- **Keep it on a leash when coding:** small diffs you read, tests that would catch
  ...
  [coding checklist](/ai4ie-demo/best-practices/checklists/#ai-assisted-coding) is
...
- **Leaking confidential data.** Anything pasted into a hosted service leaves your
  ...
  [local options on the tools pages](/ai4ie-demo/tools/local-ai/), and check your
  data-management plan before pasting.

## Next

- [Verification checklists](/ai4ie-demo/best-practices/checklists/): run one before
  results go into a paper.
- [Prompts & skills](/ai4ie-demo/best-practices/prompts-and-skills/): the copy-paste
