...
[running models locally and hardware](/ai4ie-demo/tools/local-ai/) and
[where to find datasets and pretrained models](/ai4ie-demo/tools/data-and-models/).
...
- **Local chat front-ends** (Open WebUI, LM Studio's chat, Ollama's app): chat UI over models running on your own hardware; see [Local AI & hardware](/ai4ie-demo/tools/local-ai/). **Data stays on your machine.** *(checked 2026-07)*

## Coding assistants

- **[Claude Code](https://docs.claude.com/en/docs/claude-code)**: agentic coding in the terminal/IDE: reads the repo, edits files, runs tests. *Good for:* multi-file changes, test-driven work, research code cleanup. *Not for:* unreviewed use; read the diffs (see the [coding checklist](/ai4ie-demo/best-practices/checklists/#ai-assisted-coding)). Paid. **Code leaves your machine.** *(checked 2026-07)*
...
- **[scikit-learn](https://scikit-learn.org)**: classical ML. *Start here:* a linear baseline before any deep model is one of the [ML-reproducibility recommendations](/ai4ie-demo/best-practices/checklists/#machine-learning-reproducibility). *(checked 2026-07)*
